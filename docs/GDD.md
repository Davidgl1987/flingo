...
| La Tormenta | 40 | 1 por bala | recarga ~1.8 s tras cada patrón (subida de ~1.2 s tras playtest 2026-07-15); daño completo ahí, 20 % fuera de ventana (tuning 2026-07-15, antes 0 = inmune) | patrón cada ~4.8 s de media (~3.2 s ráfaga, ~5.6 s espiral/anillos); balas ≤ 4.5 u/s |
