...
function queenBrokenColumnCount(world: World, boss: Enemy): number {
 ...
 */
function queenActivateGuardian(
  world: World,
  boss: Enemy,
 ...
 */
function queenStepLarvae(world: World, boss: Enemy, dt: number, events: EventQueue): void {
  const chaseSpeed =
